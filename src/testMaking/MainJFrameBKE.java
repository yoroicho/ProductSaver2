 ...
 * @author 00499
 */
public class MainJFrameBKE extends javax.swing.JFrame {
    ...
    private boolean basicSauceFileCopy(String sourceDir, String copyTarget, int copyMode) { // このシステムで基本とするソースファイルのコピー
        try {
            ...
            Logger.getLogger(MainJFrameBKE.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainJFrameBKE.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainJFrameBKE().setVisible(true);
            }
        });
    }
