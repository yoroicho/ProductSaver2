...
public class MakeItemsIO extends JDialog {
	...
	public static void main(String[] args) {
		try {
			MakeItemsIO dialog = new MakeItemsIO();
	 ...
	 * Create the dialog.
	 */
        public MakeItemsIO(String fileNameConf){
            this();
            this.setFileNameConf(fileNameConf);
        }
	...
	public MakeItemsIO() {
		...
		fileNameConf =  "divConf.properties";
                
		//InputStream is = this.getClass().getResourceAsStream("divConf.properties");
		FileInputStream is;
		try {
			is = new FileInputStream(getFileNameConf());
			divConf.load(is);
    ...
    /**
     * @return the fileNameConf
     */
    public String getFileNameConf() {
        return fileNameConf;
    }

    /**
     * @param fileNameConf the fileNameConf to set
     */
    public void setFileNameConf(String fileNameConf) {
